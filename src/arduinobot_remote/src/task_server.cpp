...
private:
  ...
  {
    // auto move_group_ = std::make_shared<MoveGroup>("arm_robot"); 
...
//     (void)goal_handle;
//     RCLCPP_INFO(get_logger(), "Received request to cancel goal");
//     auto arm_move_group = std::make_shared<MoveGroup>("arm_robot");
//     auto gripper_move_group = std::make_shared<MoveGroup>("gripper");
//     arm_move_group->stop();
//     gripper_move_group->stop();
//     return rclcpp_action::CancelResponse::ACCEPT;
//   }
...
//     // MoveIt 2 Interface
//     auto arm_move_group = std::make_shared<MoveGroup>("arm_robot","robot");
//     auto gripper_move_group = std::make_shared<MoveGroup>("gripper","robot");
//     std::vector<double> arm_joint_goal;
//     std::vector<double> gripper_joint_goal;
