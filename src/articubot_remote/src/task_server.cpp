...
private:
  ...
  void execute(const std::shared_ptr<rclcpp_action::ServerGoalHandle<arduinobot_msgs::action::ArduinobotTask>> goal_handle)
  {
    ...
    if (goal_handle->get_goal()->task_number == 0)
    {
      effector_pose_target.pose.position.x = 0.072531;
      effector_pose_target.pose.position.y = 0.007092;
      effector_pose_target.pose.position.z = 0.538609;
      // effector_pose_target.pose.orientation.x = 0.564625;
      // effector_pose_target.pose.orientation.y = -0.000000;
      // effector_pose_target.pose.orientation.z = 0.724309;
      effector_pose_target.pose.orientation.w = -0.395696;
